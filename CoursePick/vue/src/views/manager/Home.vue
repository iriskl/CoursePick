  ...
  <div>
    ...
    <div style="display: flex">
      <div class="card" style="flex: 50%">
        ...
        <el-timeline>
          <el-timeline-item
              v-for="(item, index) in [...data.noticeData].reverse()"
              :key="index"
              :timestamp="item.time"
          >
            {{ item.content }}
...
<!--      <div style="flex: 50%; margin-left: 5px" class="card">
        &lt;!&ndash;        <div>&ndash;&gt;
        &lt;!&ndash;          <span style="font-weight: bold">作者：</span>&ndash;&gt;
        &lt;!&ndash;          <span><a href="https://space.bilibili.com/432113931" target="_blank">武哥聊编程</a></span>&ndash;&gt;
        &lt;!&ndash;        </div>&ndash;&gt;
